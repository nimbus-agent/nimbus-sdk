 ...
 * `docs/spec/` — `batteries/v1/icalendar.md` — **and** executed by a conformance-corpus
 * guard. Both have held since `docs/spec/conformance/v1/icalendar/` went green in all
 * three bindings.
 *
